...
export default function Header() {
  return (
    <header className="w-full">
      ...
      <div className="bg-white px-6 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow">
        {/* Logo + Título */}
        <div className="flex items-center gap-3">
          <img src="/logo.svg" alt="Logo" className="h-10 w-auto" />
          <div>
            <h1 className="text-xl font-semibold text-gray-800">ArtesanosMX</h1>
            <p className="text-sm text-gray-500">Portal Oficial de Artesanías</p>
          </div>
        </div>
      ...
      {/* Menú de navegación */}
      <nav className="bg-white border-t border-gray-200 px-6 py-3 flex gap-6 text-sm text-gray-700 font-medium">
